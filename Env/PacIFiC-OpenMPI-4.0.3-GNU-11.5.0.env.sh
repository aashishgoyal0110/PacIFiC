...
export PACIFIC_HDF5_DIR="/home/wachs/local/hdf5-1.14.6"
export PACIFIC_HDF5_INCDIR="${PACIFIC_HDF5_DIR}/include"
export PACIFIC_HDF5_LIBDIR="${PACIFIC_HDF5_DIR}/lib"
#export C_INCLUDE_PATH="${PACIFIC_HDF5_INCDIR}"
if [[ -z $C_INCLUDE_PATH ]]
then 
  C_INCLUDE_PATH="${PACIFIC_HDF5_INCDIR}"
else
  C_INCLUDE_PATH="${PACIFIC_HDF5_INCDIR}:${C_INCLUDE_PATH}"
fi
export C_INCLUDE_PATH
if [[ -z $LD_LIBRARY_PATH ]]
then 
  LD_LIBRARY_PATH="${PACIFIC_HDF5_LIBDIR}"
else
  LD_LIBRARY_PATH="${PACIFIC_HDF5_LIBDIR}:${LD_LIBRARY_PATH}"
fi
export LD_LIBRARY_PATH
...
echo -e '\033[32mPACIFIC_HDF5_DIR\033[0m =' $PACIFIC_HDF5_DIR
echo -e '\033[32mPACIFIC_HDF5_INCDIR\033[0m =' $PACIFIC_HDF5_INCDIR
echo -e '\033[32mPACIFIC_HDF5_LIBDIR\033[0m =' $PACIFIC_HDF5_LIBDIR
echo -e '  '
